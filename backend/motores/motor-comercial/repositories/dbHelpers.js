/**
 * dbHelpers — Utilitários de persistência SQLite do Motor Comercial.
 *
 * Sprint 2.2: helpers de baixo nível — sem regra de negócio.
 *
 * @module motores/motor-comercial/repositories/dbHelpers
 */
